...
- **1.1 Ouverture douleur ciblée** — *Hook A recommandé sur signature SOPK visible (acné mâchoire + pilosité)*
  > *Squelette type* : "Plus de [X] femmes en France galèrent depuis des années avec des boutons sur la mâchoire qui ne partent pas, des poils noirs qui poussent là où il ne devraient pas, et des règles qui font ce qu'elles veulent. Pas par malchance. Parce qu'elles ont un truc qu'on appelle le SOPK."
- **1.2 Pivot contrasté** : "pourtant [~X] femmes ont déjà repris la main grâce à [angle Sova]"
- **1.3 Mini-stack 3 portraits flash** : Prénom + symptôme signature SOPK avant + résultat (1 ligne chacune)
- **1.4 Retour prospect** : injecter signatures SOPK selon le hook testé :
  - **Hook A (acné/pilosité)** → "et toi tu galères encore avec [poils noirs sur le menton] et [boutons sur la mâchoire qui reviennent quoi que tu fasses]"
...
- **2.1 Tu n'es pas le problème** (à étoffer)
  - Adresser frontalement "j'ai tout essayé"
  - **Levier data** : *"3 femmes SOPK sur 4 ont déjà quitté la pilule"* (C6 = 73.5%) → elles savent que c'était un masque
  - Recadrer chaque échec comme **logique systémique**, pas comme défaillance perso
- **2.2 Storytelling Eva — galère personnelle** (déclencheur, court)
  - 1ers symptômes à ~13 ans (cohérent avec diag 2019 à 21 ans → ~6 ans d'errance)
  - Parcours médical : X pros consultés, phrases entendues *("c'est du stress", "perdez du poids", "prenez la pilule")*
  - Aucune solution adaptée existante en France
  - **Le pivot émotionnel** : moment où elle décide *de chercher elle-même ce que personne n'avait cherché pour elle*
- **2.3 Bloc data systémique** : heures de formation SOPK en médecine + délai moyen diag FR + % non-diagnostiquées (*chiffres à valider avec Eva*)
- **2.4 Reformulation empowerment** : "si t'as pas eu de réponse, c'est qu'on a jamais formé personne à te la donner"

### ACTE 3 — Le travail d'Eva + autorité retournée (2:30 – 3:45)

⚠️ **Acte central pour l'autorité Sova.** L'autorité d'Eva ne vient PAS de sa galère (ça c'est juste le déclencheur d'identification). Elle vient de ce qu'elle a CONSTRUIT après. Cet acte doit raconter ce travail.

- **3.1 La recherche personnelle massive d'Eva** (le pivot autorité)
  - PubMed, études cliniques internationales, lecture quotidienne pendant des mois/années
  - **Documentation publique sur Instagram** : Eva a tout publié au fur et à mesure de ses découvertes — pas de posture experte, juste une femme qui partage ce qu'elle apprend pour elle-même. C'est ça qui a créé la communauté.
  - Identification des **briques de solution existantes** (molécules naturelles à efficacité documentée : inositols, berbérine, gymnema, NAC, chrome)
  - Constat : **ces briques existaient aux USA, en compléments dosés. Rien en France.** Il fallait commander, mélanger soi-même, croiser les doigts sur les dosages.
- **3.2 La naissance de Sova comme conséquence logique**
  - Octobre 2021 : lancement média (continuité de l'Instagram d'Eva)
  - Mai 2022 : lancement produit Ovastart + Balance tes sucres via Ulule (preuve que la communauté avait suivi avant même le produit)
  - 18 mois de formulation avec pharmacien + chercheurs pour adapter ce qu'Eva avait identifié, au standard pharmaceutique européen
- **3.3 Reconnaissance institutionnelle externe** (preuve sociale tier-1)
...
- **3.4 Autorité retournée — les pros qui se forment chez Sova**
...
- **3.5 Taille communauté actuelle** *[chiffres à fournir : IG + TikTok + newsletter + clientes]*
...
- **4.1 Cascade SOPK ancrée sur les douleurs vécues** (datas mappées) :
  - **Étape 1 — Insuline en excès** → *"c'est ce qui te crée tes pulsions sucre 17h, ton ventre qui gonfle l'après-midi, ta fatigue après les repas, et ce qui te fait stocker les kilos là où tu veux le moins"* ⟵ traite le poids comme **conséquence du mécanisme**, pas comme accroche commerciale
  - **Étape 2 — Testostérone en excès** ⭐ *(à appuyer fort — signature SOPK)* → *"c'est ce qui te crée les poils noirs au menton, sur le bas-ventre, les boutons sur la mâchoire, la chute de cheveux sur le dessus du crâne"* ⟵ ancre **C36 (pilosité 51.5%, acné 19.4%, mix 29.1%)** + **C10 #2 (26.1%)**
  - **Étape 3 — Blocage ovulation** ⭐ *(à appuyer fort — signature SOPK)* → *"c'est ce qui explique tes cycles à 38, 45 jours, ou qui sautent carrément — et c'est ce qui peut compliquer un projet bébé"* ⟵ ancre **C7 (54% cycles dysfonctionnels)** + **C10 #3 (11.3%)**
